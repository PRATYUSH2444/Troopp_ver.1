...
const DotField = memo(({
  ...
  glowColor = 'rgba(255, 106, 44, 0.25)', // Troopp Orange Accent
  ...rest
}) => {
  ...
  // Detect mobile breakpoints to bypass computation
  ...
  if (isMobile) {
    return null // Return clean fallback for mobile viewport performance limits
  }
