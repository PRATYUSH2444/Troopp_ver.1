...
const TripRoom = () => {
  ...
  return (
    <div className="page-container-trip flex flex-col gap-6 text-[#f3f1ea] min-w-0 pb-16">
      ...
      {/* HERO / EXPEDITION CONTROL BANNER */}
      <div className="hero-banner" style={{ margin: 0 }}>
        <div className="hero-content" style={{ maxWidth: '100%', width: '100%', gap: '18px' }}>
          
          {/* Row 1: Eyebrow + SOS Action Trigger */}
          <div className="flex items-center justify-between w-full flex-wrap gap-3">
            <span className="hero-eyebrow">
              <span style={{ width: '7px', height: '7px', borderRadius: '9999px', background: '#4fbe8e', boxShadow: '0 0 8px #4fbe8e', display: 'inline-block' }} />
              Active Expedition · Mission Control
            </span>

            <div className="flex items-center gap-3">
              <button
                onClick={() => setSosModalOpen(true)}
                className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold text-[#ff5470] bg-[#ff5470]/10 hover:bg-[#ff5470]/20 border border-[#ff5470]/30 transition-all cursor-pointer"
          ...
          {/* Row 2: Expedition Title & Confirmed Roster */}
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 w-full">
            <div className="flex flex-col gap-2">
              <h1 className="hero-h1 capitalize m-0 leading-tight">
                {activity?.title || 'Expedition'}
              </h1>
              <div className="flex items-center flex-wrap gap-x-3 gap-y-1.5 text-[13.5px] text-[#9ba6ad]">
                <span className="flex items-center gap-1.5">
                  ...
                  <span className="text-[#f3f1ea] capitalize font-medium">{activity?.destination || 'Destination'}</span>
                </span>
                <span className="w-1 h-1 rounded-full bg-white/20" />
                <span className="flex items-center gap-1.5">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                  <span className="text-[#f3f1ea] font-medium">{safeMembers.length} travelers</span>
                </span>
                <span className="w-1 h-1 rounded-full bg-white/20" />
                <span className="flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-3 self-start md:self-center bg-[#1a2129]/90 border border-white/10 px-4 py-2.5 rounded-2xl flex-shrink-0 shadow-lg">
              <div className="flex items-center -space-x-2.5">
                {safeMembers.slice(0, 5).map((m, idx) => (
                  <div key={m.userId || idx} className="relative ring-2 ring-[#10151a] rounded-full">
                    <Avatar src={m.avatarUrl || m.User?.Profile?.avatar_url} name={m.name || m.User?.Profile?.name} size="sm" score={m.trustScore} />
                    {m.isOnline && (
                      <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-[#4fbe8e] rounded-full border-2 border-[#10151a]" />
                    )}
                  </div>
                ))}
              </div>
              <span className="text-xs font-bold text-[#9ba6ad] whitespace-nowrap">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 w-full mt-2">
            <div className="bg-[#1a2129] border border-white/10 rounded-xl p-4 flex items-center gap-3.5 min-h-[64px] shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-[#ff6a2c]/10 flex items-center justify-center text-[#ff6a2c] flex-shrink-0">
              ...
              <div className="min-w-0">
                <div className="text-[10px] uppercase font-bold text-[#9ba6ad] tracking-wider leading-tight">Category</div>
                <div className="text-sm font-bold text-[#f3f1ea] truncate capitalize mt-0.5">{activity?.category || 'Expedition'}</div>
              </div>
            </div>
            ...
            <div className="bg-[#1a2129] border border-white/10 rounded-xl p-4 flex items-center gap-3.5 min-h-[64px] shadow-sm">
              ...
              <div className="min-w-0">
                <div className="text-[10px] uppercase font-bold text-[#9ba6ad] tracking-wider leading-tight">Departure</div>
                <div className="text-sm font-bold text-[#f3f1ea] truncate mt-0.5">
            ...
            <div className="bg-[#1a2129] border border-white/10 rounded-xl p-4 flex items-center gap-3.5 min-h-[64px] shadow-sm">
              <div className="w-10 h-10 rounded-lg bg-[#4fbe8e]/10 flex items-center justify-center text-[#4fbe8e] flex-shrink-0">
              ...
              <div className="min-w-0">
                <div className="text-[10px] uppercase font-bold text-[#9ba6ad] tracking-wider leading-tight">Per Person</div>
                <div className="text-sm font-bold text-[#4fbe8e] truncate mt-0.5">
            ...
            <div className="bg-[#1a2129] border border-white/10 rounded-xl p-4 flex items-center gap-3.5 min-h-[64px] shadow-sm">
              ...
              <div className="min-w-0">
                <div className="text-[10px] uppercase font-bold text-[#9ba6ad] tracking-wider leading-tight">Capacity</div>
                <div className="text-sm font-bold text-[#f3f1ea] truncate mt-0.5">
      ...
      >
        {[
          ...
          { id: 'info', label: 'Info & Route', icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>) },
          { id: 'expenses', label: 'Split & Ledger', icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>) },
          ...
          { id: 'polls', label: 'Decision Polls', icon: (<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>) }
        ].map((tab) => {
          ...
          return (
            <button
              ...
              style={{
                ...
                background: isActive ? 'linear-gradient(135deg, #ff6a2c 0%, #d9481a 100%)' : 'transparent',
                color: isActive ? '#1a0e08' : '#9ba6ad',
                boxShadow: isActive ? '0 4px 14px rgba(255, 106, 44, 0.3)' : 'none',
                whiteSpace: 'nowrap',
                flexShrink: 0
              }}
              onMouseEnter={(e) => {
        ...
        {isHost && (
          <button
            ...
            style={{
              ...
              border: 'none',
              transition: 'all 150ms ease',
              background: activeTab === 'manage' ? 'linear-gradient(135deg, #ff6a2c 0%, #d9481a 100%)' : 'transparent',
              color: activeTab === 'manage' ? '#1a0e08' : '#9ba6ad',
              boxShadow: activeTab === 'manage' ? '0 4px 14px rgba(255, 106, 44, 0.3)' : 'none',
              whiteSpace: 'nowrap',
              flexShrink: 0
            }}
            onMouseEnter={(e) => {
